...
export const PRAYER_STATUS_HADITH: Record<string, Hadith[]> = {
  on_time: [
    {
      id: 'on_time_1',
      category: 'on_time',
      textEnglish: 'Abdullah asked the Prophet Muhammad (ﷺ) "Which deed is the dearest to Allah?" He replied, "To offer the prayers at their early stated fixed times."',
    ...
    },
    {
      id: 'on_time_2',
      category: 'on_time',
      textEnglish: 'The Prophet (ﷺ) was asked, "Which deeds are best?" The Prophet said, "Prayer at the beginning of its time."',
    ...
    },
    {
      id: 'on_time_3',
      category: 'on_time',
      textEnglish: 'As Narrated by Ibn Umar, Allah\'s Messenger said: "The beginning of the time for prayer is pleasing to Allah, and the end of its time is pardoned by Allah."',
  ...
  delayed: [
    // Sahih al-Bukhari hadith first
    {
      id: 'delayed_2',
      category: 'delayed',
      textEnglish: 'The Prophet (ﷺ) said: "No prayer is more burdensome to the hypocrites than the dawn and evening prayers. If they knew the blessing in them, they would come even if they had to crawl."',
      source: 'Sahih al-Bukhari',
      reference: '657',
    ...
    },
    {
      id: 'delayed_6',
      category: 'delayed',
      textEnglish: 'Abu Hurairah narrated that the Prophet (ﷺ) said: "The prayer performed in congregation is twenty-five times superior to the prayer performed alone." Even if delayed, praying is still immensely rewarding.',
      source: 'Sahih al-Bukhari',
      reference: '645',
    ...
    // Sahih Muslim hadith second
    {
      id: 'delayed_1',
      category: 'delayed',
      textEnglish: 'The Prophet Muhammad (ﷺ) said: "This is the prayer of the hypocrites: He sits watching the sun decline until it is between the two horns of Satan, then he quickly pecks the ground four times while he only remembers Allah for a few moments."',
      source: 'Sahih Muslim',
      reference: '622',
    ...
    },
    {
      id: 'delayed_5',
      category: 'delayed',
      textEnglish: 'The Prophet (ﷺ) said: "Act upon your prayers before you are unable to do so. The connection between a person and shirk (polytheism) and kufr (disbelief) is the abandonment of prayer."',
      source: 'Sahih Muslim',
      reference: '82',
    ...
    // Other Sahih hadith collections third
    {
      id: 'delayed_3',
      category: 'delayed',
      textEnglish: 'The Prophet (ﷺ) said: "The covenant between us and them is prayer, so whoever abandons it has disbelieved."',
      source: 'Sunan al-Tirmidhi',
      reference: '2621 (Sahih)',
      context: 'Prayer is what distinguishes believers - delaying habitually can lead to abandoning',
    },
    {
      id: 'delayed_4',
      category: 'delayed',
      textEnglish: 'Ibn Abbas reported that the Prophet (ﷺ) said: "Allah does not accept the prayer of a man who delays a prayer until its time has ended."',
      source: 'Sunan Ibn Majah',
      reference: '694 (Hasan)',
      context: 'Delaying until the time expires is serious, but praying late is still better than missing',
    },
  ],
  ...
  missed: [
    {
      id: 'missed_1',
      category: 'missed',
      textEnglish: 'Whoever leaves the Asr prayer [deliberately], then all his good deeds will be nullified.',
    ...
    },
    {
      id: 'missed_2',
      category: 'missed',
      textEnglish: 'Umar (رضي الله عنه) narrated that the Prophet (ﷺ) said: "Whoever misses the Asr prayers (intentionally), then it is as if he lost his family and property."',
      source: 'Sahih al-Bukhari',
      reference: '552',
    ...
    },
    {
      id: 'missed_3',
      category: 'missed',
      textEnglish: 'The Prophet (ﷺ) said: "Between a man and [him falling into] polytheism and unbelief is the abandonment of Prayer."',
      source: 'Sahih Muslim',
      reference: '82',
    ...
    },
    {
      id: 'missed_4',
      category: 'missed',
      textEnglish: 'The Prophet (ﷺ) said: "The first matter that the slave will be brought to account for on the Day of Judgment is the prayer. If it is sound, then the rest of his deeds will be sound. And if it is bad, then the rest of his deeds will be bad."',
      source: 'Sunan al-Tirmidhi',
      reference: '413 (Hasan)',
    ...
    },
    {
      id: 'missed_5',
      category: 'missed',
      textEnglish: 'The Prophet (ﷺ) said: "Say to Allah, \'O Allah, do not leave me to myself even for the blink of an eye.\'" Missing prayer leaves us without Allah\'s protection, but His door of repentance is always open.',
    ...
    },
    {
      id: 'missed_6',
      category: 'missed',
      textEnglish: 'Allah says in a Hadith Qudsi: "O son of Adam, so long as you call upon Me and ask of Me, I shall forgive you for what you have done, and I shall not mind. O son of Adam, were your sins to reach the clouds of the sky and were you then to ask forgiveness of Me, I would forgive you."',
      source: 'Sunan al-Tirmidhi',
    ...
    },
    {
      id: 'missed_7',
      category: 'missed',
      textEnglish: 'The Prophet (ﷺ) said: "By the One in Whose Hand is my soul, even if you were to commit sins until your sins reach the heaven, then you were to repent, He would accept your repentance."',
      source: 'Sunan Ibn Majah',
  ...
  qadaa: [
    {
      id: 'qadaa_1',
      category: 'qadaa',
      textEnglish: 'Anas ibn Malik narrated that the Prophet (ﷺ) said: "Whoever forgets a prayer, let him offer it as soon as he remembers, for there is no expiation for it other than that."',
      source: 'Sahih al-Bukhari',
      reference: '597',
    ...
    },
    {
      id: 'qadaa_2',
      category: 'qadaa',
      textEnglish: 'The Prophet (ﷺ) said: "If one of you sleeps and misses a prayer, or forgets it, let him offer the prayer when he remembers."',
      source: 'Sahih Muslim',
      reference: '684',
    ...
    },
    {
      id: 'qadaa_3',
      category: 'qadaa',
      textEnglish: 'The Prophet (ﷺ) said: "Allah, the Exalted, says: \'O My servants, you sin by night and by day, and I forgive all sins, so seek forgiveness of Me and I shall forgive you.\'"',
      source: 'Sahih Muslim',
      reference: '2577',
    ...
    },
    {
      id: 'qadaa_4',
      category: 'qadaa',
      textEnglish: 'The Prophet (ﷺ) said: "The one who repents from sin is like one who has no sin."',
      source: 'Sunan Ibn Majah',
    ...
    },
    {
      id: 'qadaa_5',
      category: 'qadaa',
      textEnglish: 'Abu Hurairah reported that the Prophet (ﷺ) said: "When a servant (of Allah) commits a sin and says: \'O my Lord, I have committed a sin, so forgive me,\' his Lord says: \'My servant has known that he has a Lord Who forgives sins and punishes for it. I have, therefore, granted forgiveness to My servant.\'"',
      source: 'Sahih Muslim',
      reference: '2758',
    ...
    },
    {
      id: 'qadaa_6',
      category: 'qadaa',
      textEnglish: 'The Prophet (ﷺ) said: "All the sons of Adam are sinners, but the best of sinners are those who repent often."',
      source: 'Sunan al-Tirmidhi',
...
export const FRIDAY_SUNNAH_ITEMS: FridaySunnahItem[] = [
  ...
  },
  {
    ...
    hadith: {
      id: 'friday_clothes',
      category: 'friday_sunnah',
      textEnglish: 'Abu Sa\'id reported that the Prophet (ﷺ) said: "The taking of a bath on Friday is compulsory for every male Muslim who has attained the age of puberty and (also) the cleaning of his teeth with Siwak, and the using of perfume if it is available."',
      source: 'Sahih al-Bukhari',
      reference: '880',
  ...
  },
  {
    ...
    hadith: {
      id: 'friday_kahf',
      category: 'friday_sunnah',
      textEnglish: 'The Prophet (ﷺ) said: "Whoever reads Surat al-Kahf on the day of Jumu\'ah, will have a light that will shine from him from one Friday to the next."',
  ...
  },
  {
    ...
    hadith: {
      id: 'friday_salawat',
      category: 'friday_sunnah',
      textEnglish: 'The Messenger of Allah (ﷺ) said: "Friday is one of your best days. It was on it that Adam was made, and it was on it that his (soul) was taken. So increase the frequency with which you send your Salat (blessings) to me, because your Salat are presented to me."',
      source: 'Sunan Abu Dawud',
  ...
  },
  {
    ...
    hadith: {
      id: 'friday_siwak',
      category: 'friday_sunnah',
      textEnglish: 'The Prophet (ﷺ) said: "Taking a bath on Friday is obligatory for every Muslim who has reached puberty, as is using siwak, and putting on perfume if he can find it."',
      source: 'Sahih Muslim',
      reference: '846',
  ...
  },
  {
    ...
    hadith: {
      ...
      category: 'friday_sunnah',
      textEnglish: 'The Prophet (ﷺ) said in the hadith of Friday ghusl: "...then proceeds (for the Jumu\'ah prayer) and does not separate two persons sitting together (in the mosque)..."',
      source: 'Sahih al-Bukhari',
      reference: '883',
  ...
  },
  {
    ...
    hadith: {
      id: 'friday_silent',
      category: 'friday_sunnah',
      textEnglish: 'The Prophet (ﷺ) said: "When the Imam is delivering the Khutbah, and you ask your companion to be quiet and listen, then you have made Laghw (useless talk)."',
      source: 'Sahih al-Bukhari',
      reference: '892',
  ...
  },
  {
    ...
    hadith: {
      ...
      category: 'friday_sunnah',
      textEnglish: 'The Prophet (ﷺ) said: "Whoever prays four rak\'ahs before Jumu\'ah and four after it, Allah will build for him a house in Paradise."',
      source: 'Sunan al-Tirmidhi',
      reference: '429 (Hasan)',
  ...
  },
  {
    ...
    hadith: {
      ...
      category: 'friday_sunnah',
      textEnglish: 'The Prophet (ﷺ) said about Friday: "There is an hour on Friday and if a Muslim gets it while offering Salat and asks something from Allah, then Allah will definitely meet his demand." And he gestured with his hands to indicate how short that time is.',
      source: 'Sahih al-Bukhari',
      reference: '935',
